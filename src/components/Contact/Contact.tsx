...
const Contact: React.FC = () => {
  ...
  const submitContactForm = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success("Thank you for your message! We'll get back to you soon.", { id: "form-submit" });
      } else {
      ...
      toast.error("Sorry, there was a problem submitting your form. Please try again later.", { id: "form-submit" });
    } finally {
  ...
  return (
    <section>
      ...
      <a className="contact-link" href="tel:+18587741024">(858) 774-1024</a>
      {/* Email link with "mailto:" protocol */}
      <a className="contact-link" href="mailto:DanielRonFeinstein@gmail.com">DanielRonFeinstein@gmail.com</a>
      <h3 className="contact-subheader">Or use the form below:</h3>
